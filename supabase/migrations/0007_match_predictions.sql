-- ============================================================
-- 0007_match_predictions.sql
-- Devuelve los pronósticos de todos los apostadores de un partido,
-- pero SOLO si las apuestas ya están cerradas (cerrado/finalizado o ya empezó).
-- Así nadie puede espiar los pronósticos ajenos antes del cierre.
-- ============================================================
...
begin
  ...
  -- Solo si las apuestas están cerradas.
